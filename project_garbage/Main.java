...
public class Main {
    ...
    private static File modelFilename = new File(System.getProperty("user.dir"), "generated-models/project_garbage_yolov2.zip");
    ...
    private static Scalar[] colormap = {GREEN, YELLOW, RED, BLUE, PURPLE};
    ...
    public static void main(String[] args) throws Exception {
        ...
        RecordReaderDataSetIterator testIter = Iterator.testIterator(1);
        ...
        if (modelFilename.exists()) {
            ...
            ComputationGraph pretrained = (ComputationGraph) YOLO2.builder().build().initPretrained(); //high level tuning
            ...
            model = getComputationGraph(pretrained, priors, fineTuneConf);  // ComputationGraph model;
    ...
    private static ComputationGraph getComputationGraph(ComputationGraph pretrained, INDArray priors, FineTuneConfiguration fineTuneConf) {
        ...
        return new TransferLearning.GraphBuilder(pretrained)
                ...
                .addLayer("conv2d_23",
                        ...
                        "leaky_re_lu_22")
                .addLayer("outputs",
                        new Yolo2OutputLayer.Builder() //provide loss function
